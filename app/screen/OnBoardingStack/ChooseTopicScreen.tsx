...
type Props = NativeStackScreenProps<
  ...
  OnBoardingScreens.ChooseTopicScreen
>;

const ChooseTopicScreen: React.FC<Props> = ({navigation}): JSX.Element => {
  const theme = useAppTheme();
  //@ts-ignore
  const {t} = useTranslation();

  const onChoose = (value: string) => {
    navigation.navigate(OnBoardingScreens.ChooseSubTopicScreen, {topic: value});
  };
