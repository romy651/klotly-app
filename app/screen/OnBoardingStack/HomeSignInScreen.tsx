...
type Props = NativeStackScreenProps<
  ...
  OnBoardingScreens.HomeSignInScreen
>;

const HomeSignInScreen: React.FC<Props> = ({navigation}): JSX.Element => {
  ...
  const onSigUp = () => {
    navigation.replace(OnBoardingScreens.HomeSignUpScreen);
  };

  const onSignIn = () => {
    navigation.replace(OnBoardingScreens.SignInScreen);
  };
  ...
  return (
    <Screen backgroundColor={'background2'} edges={['top']}>
      ...
      <Flex
        ...
        <Flex style={{marginTop: 'auto'}} mb={'spacing10'}>
          <Text
            color="textTertiary"
            mx="spacing4"
            textAlign="center"
