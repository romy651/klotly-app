...
export const ColorsLight: Palette = {
  userThemeColor: colors.violetVibrant,
  ...
  accentAction: colors.violetVibrant,
  accentActive: colors.blue400,
  accentSuccess: colors.green300,
  accentWarning: colors.goldVibrant,
  accentCritical: colors.red400,

  accentBranded: colors.violetVibrant,
  shadowBranded: colors.violetVibrant,

  accentActionSoft: opacify(12, colors.violetVibrant),
  ...
  violetVibrant: colors.violetVibrant,
  violetDark: opacify(12, colors.violetVibrant),
};
...
export const ColorsDark: Palette = {
  ...
  backgroundActionButton: opacify(12, colors.violetVibrant),
  ...
  shadowBranded: '#5065FD',

  accentActionSoft: opacify(24, colors.violetVibrant),
  accentActiveSoft: opacify(24, colors.blue400),
