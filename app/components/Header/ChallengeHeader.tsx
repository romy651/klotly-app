...
export default function ChallengeHeader({animHeaderValue, image, title}: Props): JSX.Element {
    ...
    const textStyle = useAnimatedStyle(() => {
        ...
        const translateY = interpolate(animHeaderValue.value, [0, 230], [0, 120], {
            extrapolateLeft: Extrapolate.CLAMP,
            extrapolateRight: Extrapolate.CLAMP,
        })
    ...
    return (
        <AnimatedFlex style={[styles.header, headerStyle]}>
            <Animated.Image source={image} style={[dynamicImage, styles.image]} />
            <AnimatedText
                fontWeight="bold"
                numberOfLines={2}
                style={textStyle}
