...
import {HEIGHT, LONG_PRESS_DURATION, STORY_ANIMATION_DURATION, WIDTH} from '../../core/constants'
import {
    GestureContext,
    StoryModalProps,
...
const StoryModal = forwardRef<StoryModalPublicMethods, StoryModalProps>(
    (
        ...
        const storyIndex = useDerivedValue(() =>
            stories[userIndex.value]?.stories.findIndex(story => story.id === currentStory.value),
        )
        ...
        const scrollTo = (id: string, animated = true, sameUser = false, previousUser?: string) => {
            'worklet'
